import { urlToGifMethod, urlToSearchMethod } from '../Scripts/helpers-and-routes.js'
...
export function redirect () {
  ...
  storage.addHistoryStateAndPathName(JSON.stringify(state), JSON.stringify(pathName))
